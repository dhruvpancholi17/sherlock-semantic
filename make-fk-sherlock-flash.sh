...
#DEBIAN_PACKAGE="/var/lib/semantic/dhruv.pancholi/sherlock-semantic/fk-sherlock-flash_0.0.14.deb"
BUILD_VER_NUMBER="0.0.14"
PACKAGE="fk-sherlock-flash"
