...
#DEBIAN_PACKAGE="/var/lib/semantic/dhruv.pancholi/sherlock-semantic/fk-sherlock-flash_0.0.13.deb"
BUILD_VER_NUMBER="0.0.13"
PACKAGE="fk-sherlock-flash"
