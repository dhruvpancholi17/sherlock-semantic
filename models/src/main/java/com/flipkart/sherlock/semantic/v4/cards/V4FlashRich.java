 ...
 */
public class V4FlashRich extends V4FlashSuggestion {
    ...
    public V4FlashRich(String clickUrl, V4FlashContentType contentType, String title, String subTitle, String imageUrl) {
